			...
			<div class="am-g am-margin-top">
		       <div class="am-u-sm-4 am-u-md-2 am-text-right">
		        ...
		        <div class="am-u-sm-8 am-u-md-4 am-u-end col-end">
		           <input id="orderusername" name="orderusername" type="text" class="validate[required]" data-errormessage-value-missing="请填写收款人用户名"  value="" />
		        </div>
		     </div>
		...
		$("#questionForm").validationEngine(
				"attach",
				{
					...
					onValidationComplete : function(form, status) {// 表单提交验证完成时的回调函数,即使验证都通过也不提交表单
						if (status) {// 表单验证通过
							var path = "${ctx}/order/addSysOrder";
